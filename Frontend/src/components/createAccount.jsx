      ...
      <div className="customizeCard mt-3 mb-1 md:scale-95 mx-3">
          ...
          >
            <Form>
              <div className="customField">
                <label htmlFor="firstName" className="customizeLabel">
                  First Name
                </label>
                <Field
                  name="firstName"
              ...
              <div className="customField">
                <label htmlFor="lastName" className="customizeLabel">
                  Last Name
                </label>
                <Field
                  name="lastName"
              ...
              {/* //? Password */}
              <div className="customField">
                <label htmlFor="password" className="customizeLabel">
                  Password
                </label>
                <Field
                  name="password"
              ...
              {/* //? Confirm  Password */}
              <div className="customField">
                <label htmlFor="confirmPassword" className="customizeLabel">
                  Confirm Password
                </label>
                <Field
        ...
        <div className="hidden md:inline-block bg-gradient-to-b from-primaryDark to-primaryLight relative">
          <img
            src={building}
            alt="illustration"
            className="h-80 absolute  top-44 left-14"
          />
        </div>
      </div>
    </div>
