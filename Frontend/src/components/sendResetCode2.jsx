...
function Send() {
        ...
        //todo make the functionlity 
          ...
          const handleSubmit = e => {
            e.preventDefault();
            // setvalue({...value, [refInput.current.name] : refInput.current.value})
            let num = ''
            console.log(value);
        ...
        <div className='bg-background h-screen flex justify-center items-center' >
            <div className='bg-white grid grid-cols-1 items-center h-96 px-24 shadow-md '>
              ...
              {/* //* input section  */}
                ...
                <input  name='0' type="number" ref={refInput} className='mx-2 rounded' maxLength={1} min={1} max={9} onKeyUp={handleKeyUp} onFocus={handleFocus} onInput={splitNumber}  required/>
                <input  name='1' type="number"  className='mx-2 rounded' maxLength={1} min={1} max={9} onKeyUp={handleKeyUp} onFocus={handleFocus}   required  />
                <input  name='2' type="number"  className='mx-2 rounded' maxLength={1} min={1} max={9} onKeyUp={handleKeyUp} onFocus={handleFocus}   required  />
                <input  name='3' type="number"  className='mx-2 rounded' maxLength={1} min={1} max={9} onKeyUp={handleKeyUp} onFocus={handleFocus}   required  />
                <input  name='4' type="number"  className='mx-2 rounded' maxLength={1} min={1} max={9} onKeyUp={handleKeyUp} onFocus={handleFocus}   required  />
                <input  name='5' type="number"  className='mx-2 rounded' maxLength={1} min={1} max={9} onKeyUp={handleKeyUp} onFocus={handleFocus}   required  />
